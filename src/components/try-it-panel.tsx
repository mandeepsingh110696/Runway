			...
			{auth && (
				<div className="space-y-2">
					<label className="text-sm font-medium">
						...
						<span className="text-muted-foreground font-normal">(optional for some endpoints)</span>
					</label>
					<Input
						type="password"
						placeholder={`Enter your ${auth.envVarName.toLowerCase().replace(/_/g, ' ')} or leave empty to test`}
						value={apiKey}
